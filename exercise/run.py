...
def exe_main(exe, stdin, stdout, stderr):
    # sandbox configuration
    cookbook = {
        'args': exe,               # targeted program
        'stdin': stdin,             # input to targeted program
        'stdout': stdout,           # output from targeted program
        'stderr': stderr,           # error from targeted program
